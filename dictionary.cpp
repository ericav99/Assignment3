...
ostream& operator<< (ostream& output, const Dictionary& rightHandSideDictionary)
{
	...
	output << dictionaryPtr -> address;
	output << "     ";
	output << rightHandSideDictionary -> hashTablePtr[address];
	output << "     ";
	output << rightHandSideDictionary.;
	output << "     ";*/
	output << rightHandSideDictionary.dictionaryPtr -> hashTablePtr[rightHandSideDictionary.dictionaryPtr -> address];
	return output;
}
